					...
					<div className="card">
						<div className="card-body">
							<div className="d-flex flex-column align-items-center text-center">
                                ...
                                alt="Admin" className="rounded-circle p-1 bg-primary" width="110" />
								<div className="mt-3">
									<h4>John Doe</h4>
				...
				<div className="col-lg-8">
					...
					<div className="row">
						<div className="col-sm-12">
							<div className="card">
								<div className="card-body">
									<h5 className="d-flex align-items-center mb-3">NearBy Market Scheduled </h5>
									<p>Ontario city 1 10 km,Recommended</p>
									<div className="progress mb-3 ht-2" >
										<div className="progress-bar bg-primary" role="progressbar" id= "progress-bar-p"  aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
									<p>Ontario city 2,  20 km</p>
									<div className="progress mb-3 ht-2" >
										<div className="progress-bar bg-danger" role="progressbar" id= "progress-bar-d"  aria-valuenow="72" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
									<p>Ontario city 3, 30 km</p>
									<div className="progress mb-3 ht-2" >
										<div className="progress-bar bg-success" role="progressbar" id= "progress-bar-s"  aria-valuenow="89" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
									<p>Ontario city 4 ,  40 km</p>
									<div className="progress mb-3 ht-2" >
										<div className="progress-bar bg-warning" role="progressbar" id= "progress-bar-w"  aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
									<p>Ontario city 5 ,90 KM</p>
									<div className="progress" >
										<div className="progress-bar bg-info" role="progressbar" id= "progress-bar-i" aria-valuenow="66" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
								</div>
							</div>
						</div>
